"""
Script to add "How it Works" and "FAQ" sections to all language versions of the website
"""
...
how_it_works_translations = {
    'en': {
        ...
        'subtitle': 'Start investing smartly in 4 simple steps',
    ...
    'es': {
        'title': '¿Cómo funciona?',
        'subtitle': 'Comienza a invertir inteligentemente en 4 sencillos pasos',
    ...
    'de': {
        ...
        'subtitle': 'Beginnen Sie in 4 einfachen Schritten intelligent zu investieren',
    ...
    'it': {
        'title': 'Come funziona?',
        'subtitle': 'Inizia a investire in modo intelligente in 4 semplici passaggi',
...
faq_translations = {
    'en': {
        ...
        'subtitle': 'Everything you need to know about Vylinkia Invest',
        ...
        'a2': 'We cover European stocks (CAC40, DAX), American stocks (S&P 500, NASDAQ), as well as ETFs and top 30 cryptocurrencies. Our focus is on assets accessible via PEA for European investors.',
    ...
    'es': {
        ...
        'subtitle': 'Todo lo que necesitas saber sobre Vylinkia Invest',
        ...
        'a2': 'Cubrimos acciones europeas (CAC40, DAX), acciones americanas (S&P 500, NASDAQ), así como ETFs y el Top 30 de criptomonedas. Nuestro enfoque está en activos accesibles a través de PEA para inversores europeos.',
    ...
    'de': {
        ...
        'subtitle': 'Alles, was Sie über Vylinkia Invest wissen müssen',
        ...
        'a2': 'Wir decken europäische Aktien (CAC40, DAX), amerikanische Aktien (S&P 500, NASDAQ) sowie ETFs und Top 30 Kryptowährungen ab. Unser Fokus liegt auf Vermögenswerten, die über PEA für europäische Anleger zugänglich sind.',
    ...
    'it': {
        ...
        'subtitle': 'Tutto ciò che devi sapere su Vylinkia Invest',
        ...
        'a2': 'Copriamo azioni europee (CAC40, DAX), azioni americane (S&P 500, NASDAQ), nonché ETF e la Top 30 criptovalute. Il nostro focus è sugli asset accessibili tramite PEA per gli investitori europei.',
...
print("Translations ready for all 4 languages (EN, ES, DE, IT)")
