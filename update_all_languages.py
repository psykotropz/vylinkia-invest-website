...
languages = {
    'en': {
        ...
        'a3': 'Yes, the subscription is commitment-free. You can cancel anytime from the app settings. Subscription starts with immediate payment from day 1.',
    ...
    'es': {
        ...
        'a3': 'Sí, la suscripción es sin compromiso. Puedes cancelar en cualquier momento desde la configuración de la aplicación. La suscripción comienza con el pago inmediato desde el primer día.',
    ...
    'de': {
        ...
        'a3': 'Ja, das Abonnement ist unverbindlich. Sie können jederzeit über die App-Einstellungen kündigen. Das Abonnement beginnt mit sofortiger Zahlung ab Tag 1.',
    ...
    'it': {
        ...
        'a3': "Sì, l'abbonamento è senza impegno. Puoi cancellare in qualsiasi momento dalle impostazioni dell'app. L'abbonamento inizia con il pagamento immediato dal primo giorno.",
